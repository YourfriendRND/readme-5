...
export class PostDTO {
    ...
    @Length(ValidationParams.PostNameMinLength, ValidationParams.PostNameMaxLength, { message: POST_NAME_LENGTH_NOT_VALID })
    public name: string;
    ...
    @IsArray()
    @ArrayMaxSize(ValidationParams.TagMaxCount, { message: TAG_LIMIT_NOT_VALID })
    ...
    @Length(ValidationParams.PostTextMinLength, ValidationParams.PostTextMaxLength, { message: POST_TEXT_LENGTH_NOT_VALID })
    public text: string;
    ...
    @Length(ValidationParams.PostAnnoncementMinLength, ValidationParams.PostAnnoncementMaxLength, { message: POST_ANNOUNCEMENT_LENGTH_NOT_VALID })
    ...
    @Length(ValidationParams.PostQuoteTextMinLength, ValidationParams.PostQuoteTextMaxLength, { message: POST_QUOTE_TEXT_LENGTH_NOT_VALID })
